...
function TestTypeButton({title, description, onClick }: TestTypeButtonProps) {
  return (
    <button className={styles["test-type-btn-box"]} onClick={onClick}>
      ...
      <div className={styles["icon-container"]}>
        ...
        <svg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M26 22.5C26 21.5 27 21.8 27.5 22L37.5 29.5C38 30 38 30.5 37.5 31L27.5 38.5C27 39 26 38.8 26 38V22.5Z" fill="#CAC9CD" /></svg>
