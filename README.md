...
| 이재욱 | BE, AI | - 스크립트 작성 및 모의고사 CRUD 기능 구현<br>- PyMongo ORM을 활용한 API 개발<br>- LangChain + Whisper를 활용한 STT 처리 및 음성 평가 로직 구현<br>- SESAME TTS 모델 파인튜닝 및 RunPod 기반 모델 배포<br>- Prometheus + Grafana를 활용한 실시간 서비스 모니터링 및 성능 지표 시각화 구현 |
